 ...
 * @author munif
 */
@WebServlet(name = "Debugger", urlPatterns = {"/debbuger"})
public class Debugger extends HttpServlet {
     ...
     */
    protected void debugData(HttpServletRequest request, HttpServletResponse response)
